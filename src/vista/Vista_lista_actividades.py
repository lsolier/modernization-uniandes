...
class Vista_lista_actividades(QWidget):
    ...
    def mostrar_actividades(self, lista_actividades):
        ...
        if (self.actividades!= None and len(self.actividades)>0) :
            ...
            for item in self.actividades:
                ...
                etiqueta_actividad=QLabel(item.nombreActividad)
                ...
                btn_eliminar.clicked.connect(partial(self.eliminar_actividad,item.nombreActividad) )
    ...
    def mostrar_dialogo_editar_actividad(self,indice_actividad):
        ...
        dialogo.exec_()
        if dialogo.resultado == 1:
            self.interfaz.editar_actividad(self.actividades[indice_actividad].nombreActividad, dialogo.texto_nombre.text())
    ...
    def mostrar_dialogo_insertar_viajeros(self,actividad):   
        ...
        dialogo.mostrar_viajeros(actividad)
        dialogo.exec_()
        if dialogo.resultado == 1:
            self.interfaz.actualizar_viajeros(dialogo.viajeros)

    def eliminar_actividad(self,nombreActvididad):
        """
        ...
        if respuesta == QMessageBox.Yes:
             self.interfaz.eliminar_actividad(nombreActvididad)
